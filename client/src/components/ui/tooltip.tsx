...
/**
 * Tiny CSS-only tooltip — mirrors the admin app's helper so the
 * collapsed rail can label icons without pulling in Radix Tooltip.
 *
 * The API matches Radix (`Tooltip`, `TooltipTrigger asChild`,
 * `TooltipContent`, `TooltipProvider`) so we can swap implementations
