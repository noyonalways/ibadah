...
/**
 * Client profile dropdown menu - follows admin design pattern
 * but adapted for client-side user profile management.
 */
...
export function ProfileMenu() {
  ...
  const save = useMutation({
    ...
    onSuccess: (data) => {
      ...
      // locale immediately and re-renders in the new language.
      setUser({
        id: data.id,
        name: data.name,
        email: data.email,
