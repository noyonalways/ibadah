    ...
    <section id="features" className="relative py-24 md:py-32">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-14 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {FEATURES.map(({ key, icon: Icon, accent, iconTone }, i) => (
            <Reveal key={key} delay={i * 90}>
              <article className="lift-hover group relative h-full overflow-hidden rounded-2xl border border-border/70 bg-card/70 p-7 backdrop-blur transition-all duration-500 hover:bg-card hover:shadow-2xl hover:shadow-primary/10">
