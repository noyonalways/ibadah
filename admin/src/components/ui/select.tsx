...
/**
 * Custom Select primitive (Radix). Replaces every native <select> in the
 * admin so dropdowns share the design language and work consistently
 * across browsers / OSes. There are NO native <select> elements anywhere
 * in the admin panel.
 */
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      sideOffset={6}
      className={cn(
        'relative z-50 max-h-[--radix-select-content-available-height] min-w-[8rem] overflow-hidden rounded-lg border border-border/70 bg-popover text-popover-foreground shadow-xl shadow-primary/5',
