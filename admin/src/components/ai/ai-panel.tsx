...
export function AIPanel({
  greeting = 'Hello — I’m the Ibadah admin copilot. Ask about any page, paste metrics for a chart, or describe a question and I’ll point you at the right endpoint.',
  surface = 'admin',
  buildContext,
  suggestions,
  endpoint,
  ...
  return (
    <div className="grid h-full place-items-center px-6 py-12 text-center">
      <div>
        ...
        <p className="text-sm font-medium">Ibadah admin copilot</p>
        <p className="mt-1 text-xs text-muted-foreground">
          Ask about any admin page, or paste metrics and I&rsquo;ll chart them.
        </p>
      </div>
    </div>
  );
